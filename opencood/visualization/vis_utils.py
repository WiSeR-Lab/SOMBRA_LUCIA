...
def visualize_single_sample_output_gt(pred_tensor,
                                      ...
                                      save_path='',
                                      mode='constant',
                                      target_tensor=None, oabb=True):#oabb=True for OPV2V, False for V2V4Real
    """
    ...
    def custom_draw_geometry(pcd, pred, gt, target=None): 
    ...
    if target_tensor is not None:
        ...
        visualize_elements = [o3d_pcd] + oabbs_pred + oabbs_gt + oabbs_target
        if show_vis:
            custom_draw_geometry(o3d_pcd, oabbs_pred, oabbs_gt, oabbs_target)
    else:
