...
class PointPillarWhere2comm(nn.Module):
    ...
    def forward(self, data_dict, trust_score=None):
        ...
        #if 'attacker_index' in data_dict: # attacker index
        #    attacker_index = int(data_dict['attacker_index'])
        #    psm_single[attacker_index] = torch.max(psm_single, dim=0)[0] * 1.5
